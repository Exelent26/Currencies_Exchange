...
public class TestRunner {
   ...
   /*     String SQL = "select * from Currencies";
       ...
       /* instance.findById(2);
        ...
        //ExchangeRateDao main.java.dao = ExchangeRateDao.getInstance();
        //CurrenciesPair pair = new CurrenciesPair("USD", "EUR");
        //System.out.println(main.java.dao.findRateByCode(pair));
        //main.java.dao.findAll().forEach(System.out::println);

        //var usdrub = main.java.dao.save(new CurrenciesPair("USD","RUB"),new BigDecimal("0.65"));
            //main.java.dao.updateExchangeRate(1, BigDecimal.valueOf(0.02));
